        ...
        <div id={props.listsMenuClicked===false?"hideListsMenu":listsMenuId}>
            ...
            <div id="listsScrollDiv">
                ...
                <div id="listsMenuMyListsBigDiv">
                    {lists!==null?lists.value.map((value,index)=>{if(index>0){return(<div className="myListsDiv"key={index+0.5}onClick={clickedListDiv}><img className="myListsImages"src="https://image.shutterstock.com/image-vector/modern-flat-sliders-icon-symbol-600w-2108399819.jpg"alt="list"onClick={clickedListImg} /><h4 className="myListsText"onClick={clickedListText}key={index}>{value.displayName}</h4></div>);}}):"loading..."}
